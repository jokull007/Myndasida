...
<div class="top-bar">
    <div class="top-bar-left">
        <ul class="menu">
            <li class="menu-text">Movie Store</li>
...
<div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
    <ul class="orbit-container">
        ...
        <li  class="orbit-slide is-active">
            <img class="Mainmynd" src="http://www.wallpapersbyte.com/wp-content/uploads/2015/09/Batman-Arkham-Knight-Game-Suit-Back-Armor-Art-WallpapersByte-com-3840x2400.jpg">
        </li>
